...
tproc sweep_rectangle_test { } {
	list_equal [ sweep_rectangle 10 20 30 40 100 horizontal ] {30 20 130 40}
	list_equal [ sweep_rectangle 10 20 30 40 -100 horizontal ] {-90 20 10 40}

	list_equal [ sweep_rectangle 10 20 30 40 100 vertical ] {10 40 30 140}
	list_equal [ sweep_rectangle 10 20 30 40 -100 vertical ] {10 -80 30 20}	
}

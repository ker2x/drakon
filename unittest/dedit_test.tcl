...
tproc diagram_info_test { } {
	...
	mwc::do_create_dia first 0 0
	mwc::do_create_dia second 0 0
...
tproc switch_to_item_test { } {
	...
	mwc::do_create_dia second 0 0
	mwc::do_create_item action
	mwc::do_change_text [ list 2 ] "cool"
...
tproc change_text_test { } {
	...
	mwc::do_change_text [ list 101 preved ] docha

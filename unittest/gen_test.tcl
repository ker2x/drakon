...
tproc extract_c_signature_test { } {
	good_signature { "public" } function public {} void
	good_signature { "" } function static {} void
	good_signature { " " " #comment " "" "what?" } comment static {} void

	good_signature { "public " 
		"" 
		" int argc // number "
		" char** argv // arguments "
		" "
		"  returns int // returns 0 on success " } function public { "int argc" "char** argv" } int

	good_signature { " " "  " 
		"" 
		"  returns int // returns 0 on success " } function static {} int

	good_signature { " " "  " 
		" const char *name // the name " 
		" unsigned int id " } function static { "const char *name" "unsigned int id" } void


	bad_signature { "public" "returns double" "int count" }
	bad_signature { "public" "returns"}
}
